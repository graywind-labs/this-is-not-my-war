...
func _refresh_resources() -> void:
	gold_label.text = "金钱 %s" % PLACEHOLDER_RESOURCES.gold
	food_label.text = "粮食 %s" % PLACEHOLDER_RESOURCES.food
	wood_label.text = "木材 %s" % PLACEHOLDER_RESOURCES.wood
	stone_label.text = "石料 %s" % PLACEHOLDER_RESOURCES.stone
	iron_label.text = "铁 %s" % PLACEHOLDER_RESOURCES.iron
