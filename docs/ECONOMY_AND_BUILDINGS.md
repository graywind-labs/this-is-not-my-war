...
可进入地点包括宿舍、食堂、酒窖、菜园、铁匠铺、训练场、马厩、小教堂、小诊所、工械坊、仓库和广场。NPC 可以进入这些地点；这些地点维护公共信息空间，记录当前人数、建筑状态、工作位/床位占用和近期公开事件。

主厅、围墙、城门属于不可进入实体。它们仍有 HP、等级、修复/升级、受损和摧毁等权威状态，但不作为 NPC 常规进入地点。它们的状态归入广场信息空间：NPC 进入广场时，进入事件的地点状态快照应包含主厅 HP、围墙 HP、城门 HP 等关键状态。

广场是特殊地点，没有建筑 HP；所有室外事件默认归入广场。广场信息空间聚合室外人员、公告、战斗公开事件，以及不可进入实体的关键状态。
