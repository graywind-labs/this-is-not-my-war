...
当前实现（T0104 / T0202 / T0204 / T0205 / T0303 / T0004 / T0604 / T0701 / T0702 / T0703 / T0704 / T0705）：
...
- 暂未实现警铃、正式装备系统或生产细节；对话面板、对话事件入库、最小征召结算、入伍 NPC 自然语言指令发布与 Prompt 注入、NPC 面板非对话交互入口、主动交涉问号气泡与点击入口已实现，后端 health 和对话 Mock 仍可通过 LLMBridge / GM 调试入口验证。
...
- NPC 面板“对话”按钮打开中央对话窗口并隐藏 NPC 面板。
