...
当前仍不实现睡前总结、日记、知识图谱、LLM 记忆摘要、战斗本体、正式装备系统或公告输入 UI；这些仍由后续任务推进。旧式“地点继承历史事件”不再作为后续目标。
