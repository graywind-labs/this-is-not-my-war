...
`environment_art.json` 是 T0135 的 `environment_art_v1` 纯表现配置。P1R2 已启用城内地表 / 杂物，P2/P3 新增河谷 / 山脉，P4R 保存森林 bounds、密度与路线排除；P5 保存五类自然散布参数；P6/P7 保存日月、环境锚点和室内补光。P7R5/P7R6 保存夜雾渐入 / 渐出时刻，以及前后林缘、河谷、东山脚四区共十二簇不同位置、尺寸、旋转和密度的椭球局部雾体。它不得改变道路、碰撞、导航、时间、火源或建筑状态。
