...
func _init() -> void:
	...
	await _set_and_capture(formal_root, rig, camera, Vector3(54.0, 0.0, 22.0), 178.0, 58.0, -22.0, 50.0, "t0135_p3_mountain_station_overview.png")
	await _set_and_capture(formal_root, rig, camera, Vector3(158.0, 2.0, 25.0), 82.0, 42.0, -32.0, 48.0, "t0135_p3_mountain_mid_close.png")
	await _set_and_capture(formal_root, rig, camera, Vector3(205.0, 6.0, 30.0), 104.0, 27.0, -38.0, 50.0, "t0135_p3_mountain_low_angle.png")
	await _set_and_capture(formal_root, rig, camera, Vector3(176.0, 3.0, 270.0), 98.0, 48.0, -34.0, 50.0, "t0135_p3_mountain_north_reach.png")
	await _set_and_capture(formal_root, rig, camera, Vector3(176.0, 3.0, -245.0), 98.0, 48.0, -34.0, 50.0, "t0135_p3_mountain_south_reach.png")
	print("T0135-P3 east-mountain captures written.")
	quit(0)
