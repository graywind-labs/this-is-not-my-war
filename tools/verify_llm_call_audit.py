...
def main() -> None:
    ...
    assert backend_app_source.count("model_success_payload(response_model, result") == 8
    ...
    assert "return jsonify(model_success_payload(response_model, result))" in backend_app_source
