...
| Confirmed Demo Audio Set | Freesound 多位署名作者；逐文件见清单 | 逐文件官方 URL 见 `assets/audio/manifests/third_party_audio_credits.csv` | 2026-09-01 | 用户逐批试听确认 / v01 | CC0、CC-BY 3.0、CC-BY 4.0；逐文件见清单 | `assets/audio/manifests/third_party_audio_credits.csv` | `assets/audio/` 下 90 条运行时 WAV / OGG；精确路径与校验和见 `audio_asset_manifest.csv` | 从已下载源按用户选段剪辑、统一 48 kHz 母版、响度 / 峰值整理、循环与首尾淡入淡出；63 条 WAV、27 条 OGG |
