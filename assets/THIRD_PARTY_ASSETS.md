...
| Confirmed Demo Audio Set | Freesound / OpenGameArt 多位署名作者；逐文件见清单 | 逐文件官方 URL 见 `assets/audio/manifests/third_party_audio_credits.csv` | 2026-09-01；BGM / 虔诚提示扩充 2026-09-07；昼夜环境更新 2026-09-08；建筑施工与铁匠交互更新 2026-09-09 | 用户逐批试听确认 / v01 | CC0、CC-BY 3.0、CC-BY 4.0、CC-BY-NC 4.0；逐文件见清单 | `assets/audio/manifests/third_party_audio_credits.csv` | `assets/audio/` 下 102 条运行时 WAV / OGG；精确路径与校验和见 `audio_asset_manifest.csv` | 从已下载源按用户选段剪辑、统一 48 kHz 母版、响度 / 峰值整理；66 条 WAV、36 条 OGG。新增 9 首昼夜曲首尾各烘焙 2 秒淡化；虔诚提示采用用户选择的 v24-05 Stabat Mater，5 秒且末尾 1.5 秒渐出，CC-BY-NC 3.0；昼夜环境采用 v26 白天 04 / 夜晚 01 的 58 秒交叉衔接循环；T0393 新增短木击与铁砧单击，施工循环和升级完成声复用既有资产；白天 12 同为非商业许可，均仅适用于用户已确认的非商业参赛版本 |
